<div id="page-wrapper">
    ...
    <section id="banner">
        <div class="content">
            <header>
                <h2><?php echo $this->params['account']->pseudo; ?></h2>
                <p><?php
            ...
            <span class="image"><img src="/Sielo/Application/Site/Datas/User/<?php echo $this->params['account']->pseudo; ?>.jpg"></span>
        </div>
    ...
    <section id="informations" class="wrapper style1 special fade-up">
        <div class="container">
            <header class="major">
                <h4>Informations de l'utilisateur: <?php echo $this->params['account']->pseudo; ?></h4>
            </header>
            <div class="box alt">
                <div class="row uniform">
                    <section class="4u 6u(medium) 12u$(xsmall)">
                        ...
                        <h3>Pseudonyme</h3>
                        <p><?php echo $this->params['account']->pseudo; ?></p>
                    </section>
                    <section class="4u 6u(medium) 12u$(xsmall)">
...
//                            echo date('l j \of F Y h:i:s A', strtotime($this->params['account']->registrationDate));
    ...
    <section id="works"  class="wrapper style1 special fade-up">
        <div class="container">
            <header class="major">
                <h4>Contributions de l'utilisateur: <?php echo $this->params['account']->pseudo; ?></h4>
            </header>
            <div class="box alt">
